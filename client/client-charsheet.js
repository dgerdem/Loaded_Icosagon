...
var row2col1 = new joGroup([
	...
	new joFlexrow([
		...
		new joInput("").setStyle({width: "35px"}),
		new joInput("").setStyle({width: "35px"})]).setStyle({width: "225px"}),
	new joFlexrow([
...
var row2col2 = new joGroup([
	...
	new joFlexrow([
		...
		new joInput().setStyle({width: "35px"}),
		new joInput().setStyle({width: "35px"}),
		new joInput().setStyle({width: "35px"})]).setStyle({width: "450px"}),
	new joDivider(),
	new joFlexrow([
	...
	new joFlexrow([
		...
		new joInput().setStyle({width: "35px"}),
		new joInput().setStyle({width: "35px"}),
		new joInput().setStyle({width: "35px"})]).setStyle({width: "375px"}),
	new joDivider(),
	new joFlexrow([
		new joLabel("Touch AC").setStyle({width: "35px"}), 
		new joInput().setStyle({width: "35px"}), 
		new joLabel("Flat-Footed").setStyle({width: "35px"}),
		new joInput().setStyle({width: "35px"})]).setStyle({width: "250px"}),
	new joDivider(),
	new joFlexrow([
...
var row3col1 = new joGroup([
	...
	new joFlexrow([
		...
		new joInput().setStyle({width: "35px"}),
		new joInput().setStyle({width: "35px"}),
		new joInput().setStyle({width: "35px"})]).setStyle({width: "500px"}),
	new joFlexrow([
